...
/**
 * This class provides a wrapper for network errors when making requests to Transactions API
 */
export class BrexTransactionsError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "BrexTransactionsError";
